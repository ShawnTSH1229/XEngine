...
#define VSM_TILE_TEX_PHYSICAL_SIZE 256
#define VSM_TEX_PHYSICAL_SIZE 2048
#define VSM_TEX_PHYSICAL_WH (VSM_TEX_PHYSICAL_SIZE / VSM_TILE_TEX_PHYSICAL_SIZE)
...
#define TILE_ACTION_NEED_UPDATE (1 << 0)
#define TILE_ACTION_NEED_REMOVE (1 << 1)
#define TILE_ACTION_CACHED (1 << 2)
#define TILE_ACTION_NEED_ALLOCATE (1 << 3)
