...
public:
	...
	void TransitionResource(std::shared_ptr<XRHIStructBuffer> SrcBuffer, EResourceAccessFlag SrcAcessFlag, EResourceAccessFlag DestAcessFlag) { XASSERT(false); };
	void TransitionResource(std::shared_ptr<XRHITexture2D> SrcTexture, EResourceAccessFlag SrcAcessFlag, EResourceAccessFlag DestAcessFlag) { XASSERT(false); };
